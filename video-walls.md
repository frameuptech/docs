...
Les murs vidéo sont une fonctionnalité puissante de Digital Signage qui vous permet de créer des affichages visuels impressionnants en utilisant plusieurs écrans. Voici comment vous pouvez configurer et utiliser les murs vidéo.

## Configuration des Murs Vidéo

1. **Connexion des Écrans** : Connectez tous les écrans que vous souhaitez utiliser pour le mur vidéo à votre lecteur Digital Signage.
2. **Configuration du Logiciel** : Utilisez le portail Digital Signage pour configurer les paramètres du mur vidéo. Vous pouvez définir la disposition des écrans, le contenu à afficher, et plus encore.
